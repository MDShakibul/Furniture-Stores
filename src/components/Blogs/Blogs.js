...
const Blogs = () => {
    return (
        <div className='m-3'>
            ...
            <p> <span className='fw-bold'>Answer:</span> Semantic tag is the media of machine and human communication. Human can easily explain to the machine what he wants to do. The machine can easily understand what human want to get from it. By working in this way, a beautiful interface can be created.</p>
